...
//            System.out.println(lastStr);
    ...
    public static void reverseSubstringAll(StringBuffer str, String beginStr, String endStr) {
        boolean status = true;
        while (status) {
            String result = reverseSubstring(str, beginStr, endStr);
//            log.info(result);
//            log.info(str.toString());
            status = str.indexOf(beginStr) > -1;
        }
//        return str;
    }

    public static String reverseSubstring(StringBuffer str, String beginStr, String endStr) {
        Integer beginIndex = beginStr != null ? str.indexOf(beginStr) : -1;
        Integer lastIndex = endStr != null ? str.indexOf(endStr) : -1;
        String subStr = "";
        if (beginIndex > -1 && lastIndex > -1) {
//            log.info("{}-{}", beginIndex, lastIndex);
            subStr = str.substring(beginIndex + 1, lastIndex);
            str.replace(beginIndex, lastIndex + 1, (subStr.indexOf("content") > -1 ? "@" : "") + "/");
        }
        return subStr;
    }
...
//        for (Object data : datas) {
        ...
        if (null != name && datas.containsKey(key)) {
            str = str.replace(name, String.valueOf(datas.get(key)));
        }
//        }
        return str;
    }
...
//            if(s.indexOf("@") > -1){
//                split1 = s.split(",");
////                log.info("{}", JSON.toJSONString(split1));
//
//                for (String s1 : split1) {
//                    String s2 = substring(s1, ".fa-", ":before@");
//                    if(StringUtils.notIsEmpty(s2))
//                        clNames.add(s2);
//                }
//            }
//        }
//        log.info("{}", JSON.toJSONString(clNames));
